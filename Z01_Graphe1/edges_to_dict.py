# Créé par Elève, le 02/10/2022 en Python 3.7
"""
...
def edges_to_dict(edges, oriented=True):
    ...
    # boucle sur edges
    #   mise à jour des sous dictionnaire
    # revoie du dictionnaire



    """tenttive
    print(edges,oriented)
    depart,arrive = [],[]

    ##separation des donnees
    for i in range(len(edges)):
        depart.append(edges[i][0])
        arrive.append(edges[i][1])

    etiquettes = list(set(depart + arrive))
