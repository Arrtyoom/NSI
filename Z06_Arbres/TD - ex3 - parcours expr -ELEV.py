...
class Node:
    ...
    def prefixe(self):
        ...
        left_s = self.left.prefixe()
        right_s = self.right.prefixe()

        return '{} {} {}'.format(operateur, left_s, right_s)
    ...
    def suffixe(self):
        ...
        # cas recursif
        operateur = self.value
        left_s = self.left.suffixe()
        right_s = self.right.suffixe()

        return '{} {} {}'.format(left_s, right_s, operateur)
    ...
    def evalue(self):
        ...
        return OPERATION[self.value](self.left.evalue(), self.right.evalue())
